...
echo "🔧 Wiring PostgreSQL persistence..."
...
echo "✅ PostgreSQL adapter written."

npm run typecheck || true
npm run build || true

git status
git add package.json package-lock.json lib/pg-database.ts app/api/leads/route.ts
git commit -m "Implement PostgreSQL lead order persistence" || echo "No changes to commit."
git push origin main

echo "✅ Done. Now set DATABASE_URL and submit a test lead."
