...
export default function ReportsPage(){return <RoleAIWorkspace role="owner" title="Reports And Route Learning" subtitle="Turn daily database activity into clear owner reports, route training notes, exports, restock planning, and next actions." memory={fullSystemSnapshot()}/>}
