...
const sections=[
  ...
  {title:'Company',links:[['About','/about'],['Team','/team'],['Service Areas','/delivery-map'],['Food Security Mission','/food-security-freezer-boxes'],['Contact','/contact']]},
