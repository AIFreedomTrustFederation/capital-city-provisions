...
export default function FoodSecurityFreezerBoxesPage(){return <main className="site page-flow">
  <section className="page-hero poster-frame"><div><p className="eyebrow">Food Security</p><h1>Stocked-home planning without the panic.</h1><p className="lead">A practical way to keep real meals available for busy weeks, emergencies, and long-range household planning.</p><div className="actions"><a href="/family-freezer-boxes">View Boxes</a><a href="/#delivery-zone-check">Check ZIP</a></div></div><img src="/images/freezer-rancher.png" alt="Stocked-home planning box"/></section>
  ...
  <section className="cta poster-frame final-cta"><p className="eyebrow">Plan Ahead</p><h2>Start with ZIP, household size, and budget.</h2><p>The concierge captures the essentials so follow-up can be specific instead of generic.</p><div className="actions"><a href="/#delivery-zone-check">Check ZIP</a><a href="/freezer-boxes">Compare Boxes</a></div></section>
</main>}