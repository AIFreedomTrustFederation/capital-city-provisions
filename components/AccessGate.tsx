...
const ACCESS_COPY={
  driver:{label:'Driver Access',hint:'Enter the driver code to open assigned stops, delivery status, fulfillment notes, restock issues, fuel/miles, and turn-ins.'},
  owner:{label:'Owner Access',hint:'Enter the owner code to open live database records, reports, route learning, restock risk, exports, and internal AI tools.'}
};
