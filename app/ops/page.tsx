...
const flow=[['Capture','ZIP checks, box requests, giveaway entries, wholesale leads, and customer notes become structured memory.'],['Reserve','Inventory and route capacity are checked before delivery promises get stronger.'],['Operate','Drivers use route and order memory to complete the day and submit turn-ins.'],['Review','Owners chat with the day, exports, reports, route risk, and follow-up priorities.'],['Learn','Route notes, conversion outcomes, missed stops, and customer preferences improve the next route plan.']];
const inventory=[['Beef','260 lbs available','Protect steak bundles and family boxes.'],['Chicken','220 lbs available','Good support for mixed family packs.'],['Seafood','70 lbs available','Watch surf and turf promises.'],['Pork','160 lbs available','Useful for rancher and monthly freezer plans.']];

export default function OpsHubPage(){return <AccessGate role="owner"><main className="site page-flow">
