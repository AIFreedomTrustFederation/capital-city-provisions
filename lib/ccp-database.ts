...
export function emptyDatabase():MutableDatabase{return {customers:[],orders:[],driverUpdates:[],restockIssues:[],learningEvents:[]};}
...
export function sampleDatabase():MutableDatabase{return {customers:[...sampleCustomers],orders:[...sampleOrders],driverUpdates:[...sampleDriverUpdates],restockIssues:[...sampleRestockIssues],learningEvents:[...sampleLearningEvents]};}
