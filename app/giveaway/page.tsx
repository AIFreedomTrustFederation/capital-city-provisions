...
export default function GiveawayPage(){return <main className="site page-flow">
  ...
  <section className="section"><p className="eyebrow">Order Bonus</p><h2>Want the cheesecake offer too?</h2><p className="lead">Check your ZIP, reserve a qualifying first freezer box within 48 hours, and ask sales to apply the cheesecake thank-you gift. One per household, route and inventory permitting.</p><div className="actions"><a href="/#delivery-zone-check">Check My Route</a><a href="/family-freezer-boxes">Compare Boxes</a></div></section>
</main>}