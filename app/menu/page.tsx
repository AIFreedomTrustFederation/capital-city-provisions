  ...
  return (
    <main className="graphic-menu-page">
      ...
      <style>{`
        ...
        @media(max-width:820px){.qr-hero{grid-template-columns:1fr;text-align:center;border-radius:18px}.qr-hero-copy div{justify-content:center}.qr-hero-copy a{width:100%;text-align:center}.qr-hero-code{order:-1}.qr-hero-code img{max-width:220px}.graphic-menu-header{display:block}.graphic-menu-sheet{border-radius:14px}}
      `}</style>
    </main>
  );
}
