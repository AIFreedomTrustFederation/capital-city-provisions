...
export const sampleDriverSalesLeads:DriverSalesLead[]=[
  {id:'SALE-2101',driver:'Marco',sourceStopId:'CCP-1007',sourceCustomer:'M. Ramirez',routeId:'roseville',leadName:'R. Walker',email:'walker@example.com',phone:'916-555-2101',address:'Roseville CA',zip:'95661',area:'Roseville',need:'Family freezer restock',offer:'Family Box + cheesecake thank-you',estimatedValue:525,status:'queued',temperature:'hot',note:'Asked about weeknight meals and ground beef.',createdAt:now,updatedAt:now},
  {id:'SALE-2102',driver:'Marco',sourceStopId:'CCP-1014',sourceCustomer:'Golden Oak Catering',routeId:'roseville',leadName:'Sierra Prep Kitchen',email:'buyer@example.com',phone:'916-555-2102',address:'Roseville CA',zip:'95678',area:'Roseville',need:'Recurring wholesale quote',offer:'Wholesale sample sheet',estimatedValue:1180,status:'pitched',temperature:'hot',note:'Catering buyer wants simple protein pricing.',ownerOverride:'Owner approved going out of route if catering buyer confirms recurring account.',aiInstruction:'Prioritize this lead for wholesale follow-up and route hook planning.',createdAt:now,updatedAt:now}
];
