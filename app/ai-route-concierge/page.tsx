...
export default function RouteConciergePage(){return <main className="site page-flow">
  <section className="page-hero poster-frame"><div><p className="eyebrow">Route Concierge</p><h1>Check your delivery route before you pick a box.</h1><p className="lead">Use this guide to understand delivery fit, freezer-box options, launch bonuses, and free giveaway entry before you submit a request.</p><div className="actions"><a href="/#quick-route">Check ZIP</a><a href="/customer-concierge">Get Help Choosing</a><a href="/freezer-boxes">View Boxes</a></div></div><img src="/images/capital-city-hero.png" alt="Capital City Provisions route concierge"/></section>
