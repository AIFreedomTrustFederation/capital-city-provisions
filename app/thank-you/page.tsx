...
export default function ThankYouPage(){return <main className="site page-flow">
  <section className="page-hero poster-frame"><div><p className="eyebrow">Request Saved</p><h1>Your stocked-home plan is ready to continue.</h1><p className="lead">We saved the useful pieces: route, box interest, budget, and follow-up details. Nothing needs to pop up again unless you open it.</p><div className="actions"><a href="#saved-confirmation">Review Saved Plan</a><a href="/giveaway">Enter Giveaway Free</a><a href="/how-delivery-works">How Delivery Works</a></div></div><img src="/images/launch-consultation-support.webp" alt="Capital City Provisions confirmation"/></section>
