...
export default function WholesalePage(){return <main className="site page-flow">
  <section className="page-hero poster-frame"><div><p className="eyebrow">Wholesale</p><h1>Supply that keeps serious kitchens moving.</h1><p className="lead">Meat, seafood, poultry, and pork support for restaurants, churches, lodges, caterers, food trucks, and event teams.</p><div className="actions"><a href="/contact">Request Pricing</a><a href="/catalog">View Catalog</a></div></div><img src="/images/launch-wholesale-provisions.webp" alt="Wholesale provisioning"/></section>
