...
export default function MeatDeliverySacramentoPage(){return <main className="site page-flow">
  <section className="page-hero poster-frame"><div><p className="eyebrow">Meat Delivery Sacramento</p><h1>Premium meat delivery for Sacramento-area freezers.</h1><p className="lead">Capital City Provisions delivers freezer-ready proteins through practical local routes, starting with your ZIP code.</p><div className="actions"><a href="/#quick-route">Check My ZIP</a><a href="/family-freezer-boxes">Family Freezer Boxes</a></div></div><img src="/images/capital-city-hero.png" alt="Meat delivery Sacramento"/></section>
