...
export default function HowDeliveryWorksPage(){return <main className="site page-flow">
  <section className="page-hero poster-frame"><div><p className="eyebrow">How Delivery Works</p><h1>Check the area. Build the plan. Get stocked.</h1><p className="lead">Capital City Provisions is built around a simple promise: confirm the route first, match the right freezer box second, and make the delivery feel clean, clear, and worth getting excited about.</p><div className="actions"><a href="/#quick-route">Check ZIP</a><a href="/freezer-boxes">Build My Box</a><a href="/menu">View Menu</a></div></div><img src="/images/capital-city-hero.png" alt="Capital City Provisions delivery planning"/></section>
