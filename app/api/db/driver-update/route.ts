...
import { applyDriverUpdate, buildDriverUpdateRecord, getOrderLifecycle } from '../../../../lib/ccp-database';
...
export async function POST(request:Request){
  try{
    ...
    const update=hasDb?buildDriverUpdateRecord(input):applyDriverUpdate(input);
