  ...
  return <>
    <div className="quick-route" id="quick-route">
      ...
      {route&&<div className="quick-result">
        ...
        </form>:<p className="quick-sent">Route request received. We will use this for freezer-box follow-up.</p>}
      </div>}
