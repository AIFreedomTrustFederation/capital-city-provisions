...
export default function FreezerBoxesSacramentoPage(){return <main className="site page-flow">
  <section className="page-hero poster-frame"><div><p className="eyebrow">Freezer Boxes Sacramento</p><h1>Freezer boxes for Sacramento-area families.</h1><p className="lead">Build a freezer box around your ZIP, family size, protein preferences, and monthly budget.</p><div className="actions"><a href="/family-freezer-boxes">Compare Family Boxes</a><a href="/#delivery-zone-check">Check My Route</a></div></div><img src="/images/freezer-family.png" alt="Freezer boxes Sacramento"/></section>
