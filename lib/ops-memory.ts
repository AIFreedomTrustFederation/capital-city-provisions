...
export type OpsRoute={id:string;name:string;day:string;window:string;zips:string[];status:RouteStatus;capacity:number;reserved:number;driver:string;priority:string;learnings:string[];};
